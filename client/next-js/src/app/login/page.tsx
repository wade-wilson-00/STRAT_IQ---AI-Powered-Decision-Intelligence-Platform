  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-strat-bg px-4">
      ...
      >
        ...
        <p className="mb-6 text-center text-sm text-slate-400">Sign in to your STRAT_IQ account</p>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-strat-card/80 px-3 text-slate-500">or continue with email</span>
          </div>
        </div>
