...
import { validateRevenueForm } from "../lib/validation.js";
...
const Revenue = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const validationErrors = validateRevenueForm(form);
    if (validationErrors) {
    ...
    try {
      ...
      toast.success(`Forecast complete: $${forecast.metrics.predictedMRR.toLocaleString()} predicted MRR`);
    } catch (err) {
