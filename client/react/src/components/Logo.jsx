    ...
    <div className="inline-flex items-center gap-3">
      <div className="relative flex h-10 w-10 items-center justify-center rounded-full border border-slate-800/80 bg-slate-950/80 shadow-glow-purple">
        ...
        >
          ...
          <rect
            ...
            rx="8"
            fill="none"
            stroke="url(#stratiq-gradient)"
            strokeWidth="1.6"
          />
          <path
            d="M10 21c1.8-3.2 3.8-5 6.2-5.6 2.2-.5 4.4.4 6.3 2.3"
            stroke="url(#stratiq-gradient)"
            strokeWidth="2"
            strokeLinecap="round"
            fill="none"
          ...
          />
          <path
            d="M11 10.5c1.2-.8 2.7-1.3 4.4-1.3"
            stroke="url(#stratiq-gradient)"
            strokeWidth="1.6"
            strokeLinecap="round"
            fill="none"
      ...
      {!compact && (
        <div className="flex flex-col leading-tight">
          <span className="text-lg font-semibold tracking-[0.24em] text-slate-50 md:text-xl">
            STRAT_IQ
          </span>
